...
namespace CIHDS_Project
{
    static class DrawIt
    {
        ...
        /// </summary>
        private static Brush handOpenBrush = new SolidColorBrush(Color.FromArgb(128, 0, 255, 0));
        ...
        /// </summary>
        private static Brush trackedJointBrush = new SolidColorBrush(Color.FromArgb(255, 68, 192, 68));

        /// <summary>
        /// Brush used for drawing joints that are currently inferred
        /// </summary>
        private static Brush inferredJointBrush = Brushes.Yellow;
        ...
        public static void DrawBody(IReadOnlyDictionary<JointType, Joint> joints, IDictionary<JointType, Point> jointPoints, DrawingContext drawingContext, Pen drawingPen, List<Tuple<JointType,JointType>> bones)
        {
            // Draw the bones
        ...
        public static void DrawBone(IReadOnlyDictionary<JointType, Joint> joints, IDictionary<JointType, Point> jointPoints, JointType jointType0, JointType jointType1, DrawingContext drawingContext, Pen drawingPen)
        {
        ...
        /// <param name="drawingContext">drawing context to draw to</param>
        public static void DrawClippedEdges(Body body, DrawingContext drawingContext, double displayWidth, double displayHeight)
        {
